...
public class AdapterrViewPager extends ViewPager {
    public static final String MY_SCROLLER = "myScroller";

    public AdapterrViewPager(@NonNull Context context) {
        super(context);
        setMyScroller();
    }

    public AdapterrViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        setMyScroller();
    }
